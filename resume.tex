...
\begin{rSubsection}{Software Engineer - II}{September 2025 - Present}
{AI Growth Private Limited}{}
\item Building a new app for the Indian stock market, taking care of all the backend and systems work
\item Maintaining 3 services - core API, a realtime websocket layer, and a job scheduling system
\item Technologies used: Node.js, Go, PostgreSQL, Redis, Docker
\end{rSubsection}
    
\begin{rSubsection}{Cofounder, CTO}{July 2024 - August 2025}
{Mars Computers}{}
\item We're building powerful remote desktops for creative professionals, using our fast, in-house video streaming pipeline written in Rust and APIs in Go. 
\item We raised capital from WTFund - India’s premier non-dilutive grant fund for emerging entrepreneurs.
\item Built our own in-house low-latency video streaming pipeline (better than RDP and alike, short of 2 frames by Parsec) in Rust. 
\end{rSubsection}
